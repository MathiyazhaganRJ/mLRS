...
bool rx_ser_or_com_serial = true;
void ser_or_com_init(void) { rx_ser_or_com_serial = true; }
bool ser_or_com_serial(void) { return rx_ser_or_com_serial; }
void ser_or_com_set_to_com(void) { rx_ser_or_com_serial = false; }
